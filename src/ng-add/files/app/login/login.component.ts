...
import { projectVersion } from '../app.env';
import { rememberLoggedIn, validateEmail } from '../shared/global-utils/functions';
...
export class LoginComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  connect() {
    if (this.userNameCtrl.valid) {
      ...
      console.error('Veuillez saisir votre adresse e-mail Servier ou Biogaran');
    }
  }
